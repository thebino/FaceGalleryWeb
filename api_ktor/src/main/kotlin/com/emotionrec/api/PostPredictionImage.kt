...
import com.emotionrec.api.models.RGB
 ...
 */
fun Routing.postPredictionImage(inferenceService: LocalInferenceService) {
    post("/predictionImage") {
        ...
        if (imageInputStream != null) {
            ...
            imageInputStream.use { its -> file.outputStream().buffered().use { its!!.copyTo(it) } }
 ...
 */
private fun getImagePrediction(file: File, inferenceService: LocalInferenceService): Either<PredictionError, PredictionResponse> {
